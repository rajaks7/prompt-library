...
const uniqueCategories = categories && categories.length > 0
  ...
  const getGridColumns = () => {
    if (isClient && windowWidth < 640) return '1fr'
    if (isClient && windowWidth < 768) return 'repeat(2, 1fr)'
    if (isClient && windowWidth < 1024) return 'repeat(3, 1fr)'
    return 'repeat(4, 1fr)'
  }
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f1f1f1ff', overflowX: 'hidden', boxSizing: 'border-box' }}>
      ...
      <header style={{ 
        ...
        padding: isClient && windowWidth < 768 ? '16px 0' : '24px 0',
        boxShadow: '0 2px 8px rgba(0,0,0,0.04)'
      }}>
        <div style={{ 
          maxWidth: '1280px', 
          margin: '0 auto', 
          padding: isClient && windowWidth < 640 ? '0 16px' : '0 24px',
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'space-between',
          flexWrap: isClient && windowWidth < 768 ? 'wrap' : 'nowrap',
          gap: isClient && windowWidth < 768 ? '16px' : '20px'
        }}>
          {/* Logo */}
          ...
          <div style={{ 
            display: 'flex', 
            alignItems: 'center', 
            gap: isClient && windowWidth < 640 ? '12px' : '20px',
            flexWrap: isClient && windowWidth < 640 ? 'wrap' : 'nowrap',
            justifyContent: isClient && windowWidth < 768 ? 'center' : 'flex-start'
          }}>
            <h1 style={{ 
              fontSize: isClient && windowWidth < 640 ? '20px' : isClient && windowWidth < 768 ? '24px' : '32px',
              fontWeight: '700', 
              fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",
              color: '#1a202c',
              margin: 0,
              letterSpacing: '-0.5px',
              textAlign: isClient && windowWidth < 768 ? 'center' : 'left'
            }}>
              PROMPT LIBRARY
            </h1>
            <div style={{
              ...
              color: 'white',
              padding: isClient && windowWidth < 640 ? '8px 14px' : '10px 18px',
              borderRadius: '25px',
              fontSize: isClient && windowWidth < 640 ? '14px' : '16px',
              fontWeight: '700',
          ...
          {isClient && windowWidth >= 768 && <div style={{ width: '200px' }}></div>}
        </div>
      </header>
      ...
      <div style={{
        ...
        <div style={{
          ...
          padding: isClient && windowWidth < 768 ? '20px 0' : '32px 0',
          width: '100vw',
          position: 'relative',
          left: '50%',
          right: '50%',
          ...
          <div style={{ 
            maxWidth: isClient && windowWidth < 768 ? '100%' : '800px',
            margin: '0 auto', 
            padding: isClient && windowWidth < 640 ? '0 16px' : '0 24px'
          }}>
            <div style={{ position: 'relative', width: '100%' }}>
              <div style={{ 
                ...
                <Search 
                  size={isClient && windowWidth < 640 ? 18 : 20}
                  style={{ 
                    position: 'absolute', 
                    left: isClient && windowWidth < 640 ? '12px' : '16px',
                    color: '#9ca3af',
                    zIndex: 10
                  }} 
                />
                <input
                  ...
                  style={{
                    width: '100%',
                    padding: isClient && windowWidth < 640 ? '12px 80px 12px 40px' : '16px 120px 16px 48px',
                    fontSize: isClient && windowWidth < 640 ? '14px' : '16px',
                    fontFamily: "'Inter', sans-serif",
                    border: 'none',
                    borderRadius: '25px',
                ...
                <button
                  style={{
                    ...
                    color: 'white',
                    border: 'none',
                    padding: isClient && windowWidth < 640 ? '8px 16px' : '12px 24px',
                    borderRadius: '20px',
                    fontWeight: '600',
                    fontFamily: "'Inter', sans-serif",
                    cursor: 'pointer',
                    fontSize: isClient && windowWidth < 640 ? '12px' : '14px'
                  }}
                >
                  Search
                </button>
        ...
        <div style={{
          ...
          padding: isClient && windowWidth < 640 ? '12px 0' : '16px 0'
        }}>
          <div style={{ 
            maxWidth: '1280px', 
            margin: '0 auto', 
            ...
            <div style={{ 
              display: 'flex', 
              alignItems: 'center', 
              gap: isClient && windowWidth < 640 ? '8px' : '12px',
              flexWrap: 'wrap',
              minWidth: 0
            }}>
              <select
                ...
                onChange={handleFilterChange}
                style={{
                  padding: isClient && windowWidth < 640 ? '6px 8px' : '8px 12px',
              ...
              {(filters.tool || filters.category || filters.rating || filters.search) && (
                <button
                  ...
                  style={{
                    padding: isClient && windowWidth < 640 ? '6px 12px' : '8px 16px',
                    border: '1px solid #cbd5e0',
                    borderRadius: '6px',
                    backgroundColor: 'white',
                    color: '#e53e3e',
            ...
            {/* Right Controls */}
            <div style={{ display: 'flex', alignItems: 'center', gap: isClient && windowWidth < 640 ? '8px' : '12px' }}>
              <div style={{ 
                display: 'flex', 
                border: '1px solid #cbd5e0', 
                borderRadius: '6px',
                ...
                <button
                  ...
                  style={{
                    padding: isClient && windowWidth < 640 ? '6px 8px' : '8px 10px',
                    border: 'none',
                ...
                >
                  <Grid size={isClient && windowWidth < 640 ? 14 : 16} />
                </button>
                <button
                ...
                >
                  <List size={isClient && windowWidth < 640 ? 14 : 16} />
                </button>
              </div>
      ...
      {selectionMode && (
        <div style={{
          ...
          <div style={{ 
            display: 'flex', 
            alignItems: 'center', 
            gap: isClient && windowWidth < 640 ? 8 : 12,
            fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif" 
          }}>
            <div style={{ fontWeight: 700, color: '#0f172a', fontSize: isClient && windowWidth < 640 ? '14px' : '16px' }}>
            ...
            <button
              ...
              style={{ 
                padding: isClient && windowWidth < 640 ? '6px 10px' : '8px 12px',
                borderRadius: 8, 
          ...
          <div style={{ display: 'flex', gap: isClient && windowWidth < 640 ? 6 : 8 }}>
            <button
              onClick={() => {
                if (selectedPrompts.length === 0) return
      ...
      <div style={{ 
        ...
        {filteredPrompts.length === 0 ? (
          <div style={{ 
            ...
            <h3 style={{ 
              fontSize: isClient && windowWidth < 640 ? '18px' : '20px',
              fontWeight: '600', 
              marginBottom: '8px', 
              fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif" 
            }}>
          ...
          <div style={{ 
            background: 'white', 
            borderRadius: 12, 
            padding: isClient && windowWidth < 640 ? '8px' : '12px',
            border: '1px solid #e6eef6',
            overflowX: 'auto'
          }}>
            <div style={{ 
                    ...
                    <tr key={p.id} style={{ borderBottom: '1px solid #f1f3f4', cursor: 'pointer' }}>
                      ...
                      <td style={{ padding: '10px 12px', minWidth: '200px' }}>
                        <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                          <div style={{ 
                            width: isClient && windowWidth < 640 ? 48 : 72, 
                            height: isClient && windowWidth < 640 ? 36 : 56,
                            background: '#f3f4f6', 
                            borderRadius: 8, 
                            overflow: 'hidden', 
                            flexShrink: 0 
                            ...
                            {p.attachment_filename ? (
                              ...
                              <div style={{ 
                                ...
                                color: '#9aa0a6',
                                fontSize: isClient && windowWidth < 640 ? '10px' : '12px'
                              }}>
                                No Image
                              </div>
                            )}
                          ...
                          <div style={{ minWidth: 0 }}>
                            <div style={{ 
                              fontWeight: 600, 
                              fontSize: isClient && windowWidth < 640 ? '13px' : '14px',
                              overflow: 'hidden',
                            ...
                            <div style={{ 
                              fontSize: isClient && windowWidth < 640 ? '11px' : '12px',
                              color: '#6b7280', 
                              marginTop: 4,
                              overflow: 'hidden',
                              textOverflow: 'ellipsis',
                              ...
                              {(p.prompt_text || '').slice(0, isClient && windowWidth < 640 ? 60 : 120)}
                            </div>
                          </div>
                        </div>
                      </td>
                      ...
                      <td style={{ padding: '10px 12px', minWidth: '100px' }}>
                        <span style={{ 
                          ...
                          color: '#fff', 
                          fontWeight: 600, 
                          fontSize: isClient && windowWidth < 640 ? '11px' : '13px',
                      ...
                      <td style={{ padding: '10px 12px', minWidth: '80px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                          ...
                          <span style={{ 
                            marginLeft: 6, 
                            color: '#6b7280',
                            fontSize: isClient && windowWidth < 640 ? '10px' : '11px'
                          }}>
